...
class MyHorizontalList extends StatelessWidget {
  ...
  final int startColor,
      endColor; // because figma design have used linear color(2 color combination)
  @override
          ...
          children: [
            Positioned(
              ...
              left: 11,  // this value get from figma
                top: 15, // at first left side bar select design (appropriate like Recommended test Container) hold alt outside container mouse hovar to show value
                right: 120,
                child: Container(
                  ...
                  width: 115,
                  decoration: BoxDecoration(
                    color: Color(0xFFAFA8EE), // be careful to add 0xFF before color code
            ...
            Positioned(
                ...
                top: 80, // at first left side bar select design (appropriate like Recommended test Container) hold alt outside container mouse hovar to show value
                right: 32,
            ...
            Positioned(
              // this picture in figma design bottom r right er sathe lege ase
                bottom: 0, // at first left side bar select design (appropriate like Recommended test Container) hold alt outside container mouse hovar to show value
                right: 0,
                // scale use kora image ke soto kora jai but boro kora jai na
